...
onmessage = function (e) {
    switch (e.data.mode) {
        ...
        case "run":
            ...
            if (JAWS.useShare) {
                postMessage({chunkSize: JAWS.chunkSize, core: JAWS.core});
            } else {
                ...
                postMessage({chunkSize: JAWS.chunkSize, output: temp_buffer, offset: JAWS.offset * JAWS.step, core: JAWS.core});
            }
            break;
    }
}
